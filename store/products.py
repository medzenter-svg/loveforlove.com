...
PRODUCTS = [
    {
        ...
        "price": 0,
        "available": False,
        "status": "COMPLETE 24-PIECE COLLECTION",
        "description": "A complete 24-piece Mediterranean wedding stationery suite in ivory, lemon, white blossom, greenery and gold. All 24 approved formats are shown in the product gallery, including front/back pieces, folded table and place cards, and the four-part envelope suite. The online editor is connected for personal wedding details.",
        "cover": "amalfi-wedding-suite/collection-1.webp",
        "files": [],
